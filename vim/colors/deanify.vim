...
highlight CursorLine          guibg=#222222 ctermbg=25  gui=none cterm=none
...
highlight LineNr              guifg=#8db6cd ctermfg=74  guibg=#222222 ctermbg=233 gui=bold cterm=bold
...
highlight NonText             guifg=#3d5d6d ctermfg=74  guibg=#0f0f0f ctermbg=24  gui=none cterm=none
highlight Normal              guifg=#e0eee0 ctermfg=194 guibg=#0f0f0f ctermbg=24  gui=none cterm=none
...
highlight Visual              ctermfg=72  guibg=#023147 ctermbg=25  gui=none cterm=none
